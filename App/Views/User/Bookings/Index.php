...
<div class="min-h-dvh bg-slate-100">
    ...
    <div class="w-full bg-white p-6 mb-8">
        ...
        <!-- Filter Form -->
        <form method="get" action="/rooms" class="relative mb-4">
            <?= csrf_field() ?>
            ...
            <label for="filterToggle" class="w-full cursor-pointer flex items-center justify-center gap-3 bg-slate-100
            ...
            <div class="fixed left-0 right-0 bottom-0 h-[80vh] z-999 bg-white
                ...
                <div class="space-y-6">
                    ...
                    <div class="group relative">
                        <label for="" class="block text-sm text-slate-700 mb-2">
                            Tanggal Peminjaman
                        </label>
                        ...
                        transition-all duration-300 group-hover:border-gray-300 focus-within:border-emerald-500 focus-within:ring-2 focus-within:ring-emerald-200 focus-within:shadow-md">
                            ...
                            size-6 text-gray-400 transition-all duration-300 group-focus-within:text-emerald-600 group-hover:text-gray-500">
                                <path d="M8 2v4" />
                                <path d="M16 2v4" />
                            ...
                            <input type="date" name="tanggal" id=""
                                ...
                                class="flex-1 bg-transparent focus:outline-none text-slate-700 placeholder-gray-400 cursor-pointer transition-all duration-300 focus:scale-125">
                        </div>
                    </div>

                    <!-- input waktu -->
                    <div class="group relative">
                        <label for="" class="block font-semibold text-slate-700 mb-2">Waktu Mulai</label>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        foreach ($bookings as $booking):
            ...
            <div class="rounded-3xl border-2 border-gray-400 bg-gray-100 mb-4 shadow-lg mx-8">
