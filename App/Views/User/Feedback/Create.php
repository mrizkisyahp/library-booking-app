    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 mb-6">
            ...
            <div class="space-y-3">
                <div class="flex items-start">
                    <svg class="w-5 h-5 text-slate-500 mt-0.5 mr-3" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
        ...
        <form action="/feedback/store" method="POST" class="bg-white rounded-2xl shadow-lg p-6">
            ...
            <div class="mb-6">
                ...
                <div class="flex gap-2" id="star-rating">
                    <div class="flex flex-row-reverse justify-center gap-1">
                        <?php for ($i = 5; $i >= 1; $i--): ?>
                            <input type="radio" name="rating" id="rating-<?= $i ?>" value="<?= $i ?>" class="peer hidden"
                                required <?= old('rating') == $i ? 'checked' : '' ?> />
                            <label for="rating-<?= $i ?>" class="cursor-pointer">
                                <svg class="w-12 h-12 text-gray-300 transition-colors
               peer-checked:text-yellow-400
               peer-hover:text-yellow-300
               peer-hover:peer-checked:text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                                    <path
            ...
            <div class="mb-6">
                ...
                <p class="text-xs text-slate-500 mt-2">Feedback Anda akan membantu kami meningkatkan kualitas layanan
                </p>
            </div>
            <!-- Actions -->
