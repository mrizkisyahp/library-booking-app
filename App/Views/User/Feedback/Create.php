...
<div class="max-w-3xl mx-auto p-6">
    ...
    <form action="/feedback" method="post" class="space-y-6">
      ...
      <div>
        ...
        <textarea 
          name="comments" 
          rows="4" 
          placeholder="Tulis komentar Anda tentang pengalaman menggunakan ruangan..."
          class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all resize-none"
        ></textarea>
        <p class="mt-2 text-sm text-gray-500">Opsional - Bagikan pengalaman Anda untuk membantu kami meningkatkan layanan</p>
      </div>
  ...
  <!-- Back Link -->
  <div class="mt-6">
    <a href="/dashboard" class="inline-flex items-center text-emerald-600 hover:text-emerald-700 font-medium transition-colors">
      <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
