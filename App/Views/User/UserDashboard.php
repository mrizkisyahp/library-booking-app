                                    ...
                                    <div class="flex flex-col justify-start p-6">
                                        ...
                                        <div class="w-full">
                                            ...
                                            <div
                                                ...
                                                <!-- status state -->
                                                <?php if ($booking['status'] === 'draft' && $currentMembers < $requiredMembers): ?>
                                                    (Menunggu Anggota)
                                                <?php elseif ($booking['status'] === 'draft' && $currentMembers >= $requiredMembers): ?>
                                                    (Siap Dikirim)
                                            ...
                                            <p class="mb-4 flex gap-2 items-center">
                                                ...
                                                <?= (int) $currentMembers ?> /
                                                <?= isset($maximumMembers) && $maximumMembers > 0 ? (int) $maximumMembers : '∞' ?>
                                                peserta
