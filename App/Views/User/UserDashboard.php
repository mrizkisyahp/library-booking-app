    ...
    <div class="rounded-2xl p-4 mx-auto max-w-7xl">
                ...
                <div
                    ...
                    <p class="mb-4">
                        <?php if (auth()->user()->status === 'pending kubaca'): ?>
                            ...
                            <?php else: ?>
                                Untuk membuat booking, kamu harus verifikasi akun dengan mengunggah bukti KuBacaPNJ di <a
                                    href="/profile" class="font-semibold underline hover:text-gray-900">Profil</a>!
                            <?php endif; ?>
                        <?php else: ?>
                                ...
                                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                                    <div>
                                        <p class="font-semibold text-slate-800 mb-1">
                                            <span
                                                class="text-blue-600"><?= htmlspecialchars($invitation['invited_by_name']) ?></span>
                                            mengundang
                                    ...
                                    <div class="flex gap-2">
                                        <form action="/invitations/accept" method="post">
                                            ...
                                            <input type="hidden" name="invitation_id"
                                                value="<?= (int) $invitation['id_invitation'] ?>">
                                            <button type="submit"
        ...
        <?php if (!empty($myJoinRequests)): ?>
            ...
            <div class="mb-6 bg-purple-50 border-l-4 border-purple-400 rounded-lg p-5 shadow-md">
                <div class="flex items-start">
                    <svg class="w-6 h-6 text-purple-600 shrink-0 mt-0.5" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm text-slate-600 space-y-1">
                                            ...
                                            <p class="flex items-center gap-2">
                                                ...
                                                • <?= substr($request['waktu_mulai'], 0, 5) ?> -
                                                <?= substr($request['waktu_selesai'], 0, 5) ?>
                                            </p>
                                        </div>
                                    </div>
                ...
                <div class="bg-gray-100 rounded-t-3xl md:rounded-3xl shadow-lg md:shadow-none p-6 md:p-0 ">
                    <div class="bg-white rounded-3xl p-6 mb-6">
                        <h2 class="text-4xl font-bold text-slate-800 mb-6 flex items-center">
                            <svg class="size-9 mr-2 text-emerald-600" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="text-center py-12 rounded-3xl border-2 border-gray-400 bg-gray-100 mb-4">
                                <div class="flex justify-center mb-6 text-gray-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        ...
                                        stroke-linejoin="round" class="lucide lucide-frown-icon lucide-frown size-9">
                            ...
                            <div id="modal-invite"
                                ...
                                <div
                                    ...
                                    <form action="/bookings/join" method="post" class="space-y-3">
                                        ...
                                        <input type="text" name="invite_token"
                                            value="<?= htmlspecialchars($prefill ?? '') ?>"
                                            placeholder="Masukkan kode di sini...." required
                                            class="w-full px-3 py-2 text-sm border-2 border-gray-200 rounded-lg focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500 tracking-wider">
                                ...
                                <div class="rounded-3xl border-2 border-gray-400 bg-gray-100 mb-4">
                                    <div class="flex flex-col justify-start p-6">
                                        ...
                                        <div class="w-full">
                                            ...
                                            ?>
                                            <div
                                                class="px-4 py-2 mb-4 rounded-3xl font-regular border text-sm <?= $statusColor ?>">
                                                Status:
