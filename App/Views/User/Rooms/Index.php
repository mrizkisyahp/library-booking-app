...
<div class="min-h-dvh bg-slate-100">
    ...
    <div class="w-full bg-white p-6 mb-8">
        <div class="mb-4  max-w-7xl mx-auto md:px-6">
        ...
        <form method="get" action="/rooms" class="relative mb-4 max-w-7xl mx-auto md:px-6">
            ...
            <div class="relative w-full mb-4">
                ...
                <input type="text" name="nama_ruangan" value="<?= htmlspecialchars($filters['nama_ruangan'] ?? '') ?>"
                    placeholder="Cari nama ruangan..." class="w-full pl-12 pr-4 py-3 border-2 border-gray-200 rounded-2xl bg-slate-100
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 md:ml-32 px-6 ">
        <!-- loop ruangan -->
         <div class="md:col-span-3 md:grid md:grid-cols-3 gap-4 mx-auto space-y-6">
