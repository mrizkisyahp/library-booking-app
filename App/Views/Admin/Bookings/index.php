...
<div class="p-4 bg-white shadow-b-md w-full">
    <div class="flex flex-col md:flex-row items-center gap-4 p-4 justify-between">
        <div class="flex items-center gap-4">
            <span class="text-black font-bold text-4xl capitalize">
                manajemen booking
                <p class="text-gray-600 text-base font-normal">Kelola dan verifikasi booking ruangan</p>
            </span>
        </div>
        <div class="flex gap-4 mt-4 md:mt-0">
            <a href="/admin/blocked-dates"
                class="flex gap-2 bg-red-500 shadow text-white px-6 py-2 rounded-lg text-xs md:text-sm items-center font-normal hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
            ...
            <a href="/admin/bookings/create"
                class="flex gap-2 bg-primary shadow text-white px-8 py-2 rounded-lg text-xs md:text-sm items-center font-normal hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500">
...
<div class="p-6">
    ...
    <section class="bg-white shadow rounded-lg border border-gray-100 mb-6 max-w-7xl mx-auto">
        ...
        <div class="relative border-b border-gray-200">
            <div class="flex flex-nowrap gap-6 px-6 pt-4 overflow-x-auto whitespace-nowrap overscroll-x-contain
               scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
                ...
                <button onclick="location.href='/admin/bookings?view=today'" class="relative shrink-0 px-4 py-3 font-semibold transition-all
            <?= $activeView === 'today'
                ? 'text-emerald-600'
                ...
                <button onclick="location.href='/admin/bookings?view=all'" class="relative shrink-0 px-4 py-3 font-semibold transition-all
            <?= $activeView === 'all'
                ? 'text-emerald-600'
                : 'text-gray-600 hover:text-gray-800' ?>">
                    All Booking
        ...
        <div class="relative bg-gray-50 border-b border-gray-200">
            <div class="flex flex-nowrap gap-6 px-6 py-3 overflow-x-auto whitespace-nowrap overscroll-x-contain
               scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
                ...
                foreach ($statusFilters as $statusKey => $config):
                    ...
                    ?>
                    <a href="/admin/bookings?status=<?= $statusKey ?>&view=<?= htmlspecialchars($activeView) ?>" class="relative shrink-0 px-2 py-2 font-medium transition-all
                <?= $isActive
                    ? 'text-gray-900'
                    : 'text-gray-600 hover:text-gray-800' ?>">
            ...
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-gray-200">
                    <?php foreach ($bookings as $booking): ?>
                        <tr
                            class="hover:bg-gray-200 odd:bg-gray-50 even:bg-gray-100 transition-colors border-b border-gray-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <?php elseif (!empty($booking->has_been_rescheduled)): ?>
                                    <span
                                        class="block mt-1 px-2 py-0.5 text-xs font-medium text-amber-700 bg-amber-100 rounded-full">
                                        🔄 Rescheduled
                                    </span>
                                <?php endif; ?>
                            </td>
