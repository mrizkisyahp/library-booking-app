            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 space-y-5">
                <div class="flex items-center justify-between">
                    <div class="text-xl font-bold text-slate-800 flex items-center">
                        <svg class="size-8 mr-2 flex justify-center items-center text-emerald-600" fill="none"
                        ...
                        <div class="flex flex-col">
                            ...
                            <p class="text-slate-600 text-sm mb-4 font-normal">Periksa detail booking sebelum melakukan
                                verifikasi.</p>
                        </div>
                    </div>
                    <span
                ...
                <div class="space-y-4">
                    <div class="p-4 bg-slate-50 rounded-xl">
                        ...
                        <p class="text-sm text-slate-600">Kapasitas:
                            <?= htmlspecialchars($bookings->required_members) ?> -
                    ...
                    <div class="p-4 bg-slate-50 rounded-xl">
                        ...
                        <p class="text-lg font-bold text-slate-800 capitalize"><?= htmlspecialchars($pic['nama']) ?></p>
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm font-medium text-blue-900">
                                            <?= htmlspecialchars(basename($bookings->surat_path)) ?>
                                        </p>
                                    </div>
                                </div>
        ...
        <div class="space-y-6">
          ...
          <div class="p-4 bg-slate-100 rounded-xl font-mono tracking-widest text-center text-lg text-slate-800">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 space-y-5">
                ...
                <?php if ($bookings->status === 'pending'): ?>
                    <form action="/admin/bookings/verify" method="post" class="space-y-3">
                        ...
                        <button type="submit"
                            class="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-medium py-3 px-4 rounded-xl transition-colors cursor-pointer">
                            Konfirmasi Booking
                        </button>
                    </form>
                    ...
                    <div class="pt-4 border-t border-slate-200">
                        <form action="/admin/bookings/reject-pending" method="post" class="space-y-3">
                            ...
                            <?php endif; ?>
                            <button type="submit"
                                class="w-full bg-amber-600 hover:bg-amber-700 text-white font-medium text-sm cursor-pointer py-3 px-4 rounded-xl transition-colors">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 space-y-4">
                ...
                <p class="text-sm text-slate-600">Berikan peringatan ke semua anggota booking ini jika melakukan
                    pelanggaran.
                </p>
                ...
                <form action="/admin/bookings/assign-warning" method="post" class="space-y-3">
                        ...
                        <select name="warning_type_id" required
                            ...
                            <?php if (!empty($warningTypes)): ?>
                                <?php foreach ($warningTypes as $type): ?>
                                    <option value="<?= $type['id_peringatan'] ?>">
                                        <?= htmlspecialchars($type['nama_peringatan']) ?>
                                    </option>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </select>
                    ...
                    <button type="submit"
                        class="w-full bg-yellow-500 hover:bg-yellow-600 text-white font-medium py-3 px-4 rounded-xl text-sm transition-colors cursor-pointer"
