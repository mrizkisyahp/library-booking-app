    ...
    <div class="flex items-center gap-4 p-4 justify-between">
        <div class="flex items-center gap-4">
            <span class="text-black font-bold text-4xl capitalize">
                Manajemen User
                <p class="text-gray-600 text-base font-normal">Kelola dan monitor User yang terdaftar</p>
            </span>
        </div>
...
<div class="p-6 max-w-7xl mx-auto">
    ...
    <section class="mb-12">
        ...
        <div class="mt-4 flex justify-between items-center gap-4 md:gap-8">
            <p
                ...
                <div class="flex flex-col md:flex-row gap-4 md:gap-8">
                    ...
                    <label class="flex flex-col md:flex-row items-center capitalize">
                        <div class="items-center gap-4 hidden md:flex w-full">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-search-icon lucide-search size-5">
                    ...
                    <label class="flex items-center gap-4">
                        <div class="hidden md:flex">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-building-icon size-5">
                        ...
                        <div class="relative">
                            <button id="dropdownButton" type="button"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    ...
                                    stroke-linejoin="round" class="lucide lucide-chevron-down mt-0.5">
                                    <path d="m6 9 6 6 6-6" />
                                </svg>
                            </button>
                  ...
                  <?php if (($filters['status'] ?? '') === ''): ?> bg-gray-300 <?php endif; ?>" data-value="">
                    ...
                    <?php if (($filters['status'] ?? '') === $status): ?> bg-gray-300 <?php endif; ?>"
                            ...
                            <input type="hidden" id="statusSelected2" name="status"
        ...
        <?php if (($activeView ?? 'pending') === 'pending'): ?>
            <div class="px-6 py-4 bg-yellow-50 border-b border-yellow-200">
                <div class="flex items-center gap-2 text-yellow-700">
                    ...
                    <span class="text-sm font-medium">Menampilkan user dengan status "pending kubaca" yang sudah upload foto
                        KuBaca
            ...
            <div class="bg-white rounded-md shadow-md overflow-x-auto border border-gray-200">
                <table class="w-full text-sm text-left">
                                ...
                                <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700 ">
                                    <div class="hover:text-emerald-700 ">
                                        <a href="/admin/users/show?id=<?= $user->id_user ?>"
                                            class="flex items-center gap-4 accent-primary">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                  ...
                  <?php endif; ?> -->
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                                    <?= htmlspecialchars($user->status) ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                                    <!-- <div>
    ...
    <div id="imagePopUp"
        ...
        <div class="bg-white rounded-lg shadow-lg max-w-sm w-full p-4 transition-all scale-95 opacity-0 duration-300">
            ...
            <div class="flex items-center justify-start gap-4">
                ...
                <p id="popUpNama" class="text-sm font-semibold text-gray-600 capitalize">
