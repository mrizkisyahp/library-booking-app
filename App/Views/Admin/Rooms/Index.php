    ...
    <div class="flex items-center gap-4 p-4 justify-between">
        <div class="flex items-center gap-4">
            <span class="text-black font-bold text-4xl capitalize">
                Manajemen Ruangan
                <p class="text-gray-600 text-base font-normal">Kelola dan monitor ruangan yang tersedia</p>
            </span>
        </div>
        <p>
...
<div class="p-6">
    ...
    <section class="bg-white shadow rounded-lg p-6 mb-8 border border-gray-100 max-w-7xl mx-auto">
        ...
        <form method="get" action="/admin/rooms"
            class="flex  justify-between items-start md:items-center gap-6 px-4 md:px-8">
            <div class="md:items-center gap-4 md:gap-8">
                <div class="flex flex-col md:flex-row gap-6">
                    <!-- Keyword -->
                    <label class="flex flex-col md:flex-row items-center gap-2 capitalize">
                        ...
                        <tr
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm space-y-2 flex gap-2 flex-wrap">
                                <a href="/admin/rooms/show?id=<?= $room->id_ruangan ?>"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="lucide lucide-eye size-4">
                                        <path
