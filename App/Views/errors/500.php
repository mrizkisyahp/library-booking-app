...
<div class="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 p-6 text-center">
  <div class="bg-white shadow-xl rounded-2xl p-10 max-w-3xl w-full border border-gray-100">
    <div class="flex flex-col items-center space-y-3 mb-6">
      <div class="w-20 h-20 rounded-2xl bg-gradient-to-br from-yellow-500 to-orange-500 flex items-center justify-center text-white text-3xl font-bold shadow-lg">
        500
      </div>
    ...
    <a href="/login" class="inline-block mt-8 px-6 py-3 bg-yellow-600 hover:bg-yellow-700 text-white font-medium rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-0.5">
      Go to Login
    </a>
  </div>
</div>
