...
<div class="flex items-center justify-center md:justify-between min-h-dvh mx-4 md:mx-auto md:max-w-7xl">
    <!-- left side -->
    <div class="hidden md:block">
        <img src="/src/logoPinrupus.png" alt="logo" class="size-30">
        <div class="px-4 md:px-0 py-8">
            <p class="text-4xl md:text-6xl text-white font-bold capitalize w-xl">Selamat datang di PinRuPus PNJ</p>
        </div>
    </div>
    <!-- right side -->
    <div>
        ...
        <div
            ...
            <?php if ($m = flash('success')): ?>
                ...
                <div class="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-lg md:w-xl hidden peer-checked:flex
               bg-green-50 border border-emerald-500 text-emerald-800
               rounded-2xl shadow-xl p-4 transition-all">
            ...
            <?php if ($m = flash('error')): ?>
                ...
                <div class="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-lg hidden peer-checked:flex
            ...
            <div class="mt-6">
                ...
                <?= $validator?->hasError('password')
                    ...
                    : 'border-gray-300 focus:ring-emerald-500 focus:ring-offset-2 focus:border-emerald-500 transition-all' ?>" />
                        ...
                        <div class="cf-turnstile mt-4 p-2 flex justify-center"
                            data-sitekey="<?= config('TURNSTILE_SITE'); ?>" data-theme="light" data-size="normal"
