        ...
        <div class="flex flex-col md:flex-row items-center justify-center text-white mb-4">
            <div class="p-6 rounded-3xl bg-emerald-800 border-2 border-emerald-700 mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    class="lucide lucide-user-round-icon lucide-user-round size-16 shrink-0">
            ...
            <div
                class="flex items-center justify-center px-4 py-2 gap-4 rounded-2xl border
                        ...
                        <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                            ...
                            <form action="/upload-kubaca" method="post" enctype="multipart/form-data" class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="file" id="kubaca_img" name="kubaca_img" accept="image/png,image/jpeg,image/webp"
                                        required
