...
?>
  ...
  <form action="/admin/rooms" method="post">
    ...
    <fieldset>
      ...
      <label>
        Minimum Capacity
        <input type="number" name="kapasitas_min" min="1" value="<?= htmlspecialchars((string)($room->kapasitas_min ?? '')) ?>">
      </label>
      ...
      <label>
        Maximum Capacity
        <input type="number" name="kapasitas_max" min="1" value="<?= htmlspecialchars((string)($room->kapasitas_max ?? '')) ?>">
      </label>
    ...
    <fieldset>
      ...
      <label>
        Details
        <textarea name="deskripsi_ruangan" rows="4" cols="40"><?= htmlspecialchars($room->deskripsi_ruangan ?? '') ?></textarea>
      </label>
