...
try {
    ...
    // Additional 27 users (mix of dosen and mahasiswa)
    // Dosen (id_role = 2)
    ...
    // Mahasiswa (id_role = 3)
    ['id_user' => 7, 'id_role' => 3, 'nama' => 'Ahmad Fauzi', 'nip' => null, 'nim' => '2345678901', 'email' => 'ahmad.fauzi@stu.pnj.ac.id', 'password' => password_hash('password123', PASSWORD_DEFAULT), 'status' => 'active', 'jurusan' => 'Teknik Informatika', 'nomor_hp' => '08123456793', 'suspensi_terakhir' => null, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
    ['id_user' => 8, 'id_role' => 3, 'nama' => 'Dewi Lestari', 'nip' => null, 'nim' => '2345678902', 'email' => 'dewi.lestari@stu.pnj.ac.id', 'password' => password_hash('password123', PASSWORD_DEFAULT), 'status' => 'active', 'jurusan' => 'Sistem Informasi', 'nomor_hp' => '08123456794', 'suspensi_terakhir' => null, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
    ['id_user' => 9, 'id_role' => 3, 'nama' => 'Rizki Ramadhan', 'nip' => null, 'nim' => '2345678903', 'email' => 'rizki.ramadhan@stu.pnj.ac.id', 'password' => password_hash('password123', PASSWORD_DEFAULT), 'status' => 'verified', 'jurusan' => 'Teknik Elektro', 'nomor_hp' => '08123456795', 'suspensi_terakhir' => null, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
    ['id_user' => 10, 'id_role' => 3, 'nama' => 'Siti Aisyah', 'nip' => null, 'nim' => '2345678904', 'email' => 'siti.aisyah@stu.pnj.ac.id', 'password' => password_hash('password123', PASSWORD_DEFAULT), 'status' => 'suspended', 'jurusan' => 'Teknik Informatika', 'nomor_hp' => '08123456796', 'suspensi_terakhir' => date('Y-m-d H:i:s'), 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
    ['id_user' => 11, 'id_role' => 3, 'nama' => 'Budi Santoso', 'nip' => null, 'nim' => '2345678905', 'email' => 'budi.santoso@stu.pnj.ac.id', 'password' => password_hash('password123', PASSWORD_DEFAULT), 'status' => 'active', 'jurusan' => 'Sistem Informasi', 'nomor_hp' => '08123456797', 'suspensi_terakhir' => null, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
    ['id_user' => 12, 'id_role' => 3, 'nama' => 'Ani Lestari', 'nip' => null, 'nim' => '2345678906', 'email' => 'ani.lestari@stu.pnj.ac.id', 'password' => password_hash('password123', PASSWORD_DEFAULT), 'status' => 'active', 'jurusan' => 'Teknik Elektro', 'nomor_hp' => '08123456798', 'suspensi_terakhir' => null, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
    ['id_user' => 13, 'id_role' => 3, 'nama' => 'Joko Susilo', 'nip' => null, 'nim' => '2345678907', 'email' => 'joko.susilo@stu.pnj.ac.id', 'password' => password_hash('password123', PASSWORD_DEFAULT), 'status' => 'verified', 'jurusan' => 'Teknik Informatika', 'nomor_hp' => '08123456799', 'suspensi_terakhir' => null, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
    ['id_user' => 14, 'id_role' => 3, 'nama' => 'Dian Puspita', 'nip' => null, 'nim' => '2345678908', 'email' => 'dian.puspita@stu.pnj.ac.id', 'password' => password_hash('password123', PASSWORD_DEFAULT), 'status' => 'active', 'jurusan' => 'Sistem Informasi', 'nomor_hp' => '08123456800', 'suspensi_terakhir' => null, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
    ...
    ['id_user' => 17, 'id_role' => 3, 'nama' => 'Bambang Setiawan', 'nip' => null, 'nim' => '2345678911', 'email' => 'bambang.setiawan@stu.pnj.ac.id', 'password' => password_hash('password123', PASSWORD_DEFAULT), 'status' => 'verified', 'jurusan' => 'Sistem Informasi', 'nomor_hp' => '08123456803', 'suspensi_terakhir' => null, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
    ...
    ['id_user' => 20, 'id_role' => 3, 'nama' => 'Rina Wijaya', 'nip' => null, 'nim' => '2345678914', 'email' => 'rina.wijaya@stu.pnj.ac.id', 'password' => password_hash('password123', PASSWORD_DEFAULT), 'status' => 'verified', 'jurusan' => 'Sistem Informasi', 'nomor_hp' => '08123456806', 'suspensi_terakhir' => null, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
    ...
    ['id_user' => 24, 'id_role' => 3, 'nama' => 'Lina Marlina', 'nip' => null, 'nim' => '2345678918', 'email' => 'lina.marlina@stu.pnj.ac.id', 'password' => password_hash('password123', PASSWORD_DEFAULT), 'status' => 'verified', 'jurusan' => 'Teknik Elektro', 'nomor_hp' => '08123456810', 'suspensi_terakhir' => null, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
    ...
    ['id_user' => 29, 'id_role' => 3, 'nama' => 'Budi Santosa', 'nip' => null, 'nim' => '2345678923', 'email' => 'budi.santosa@stu.pnj.ac.id', 'password' => password_hash('password123', PASSWORD_DEFAULT), 'status' => 'verified', 'jurusan' => 'Sistem Informasi', 'nomor_hp' => '08123456815', 'suspensi_terakhir' => null, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
